...
A port of [GenMDM v1.02](https://github.com/little-scale) to the Raspberry Pi Pico / RP2040, with a few small fixes and quality-of-life improvements over the original AVR firmware.
...
Credit to [little-scale](https://github.com/little-scale) for the original GenMDM firmware, hardware and ROM.
